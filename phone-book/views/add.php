        ...
        <div class="col-md-12">
            <form class="number_form" method="post">
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="exampleInputNumber" name="form_number" placeholder="Номер">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="form_description" placeholder="Описание"></textarea>
                </div>
